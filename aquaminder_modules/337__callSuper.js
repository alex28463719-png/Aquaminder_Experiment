...
// Function ID: 4095
// Name: _callSuper
// Dependencies: [1, 12, 13, 23, 25, 26, 28, 321, 311, 317, 313]

// Module 337 (_callSuper)
...
let closure_8 = module_1(_callSuper3);

export default ((arg0) => {
  class AnimatedDivision {
    constructor(arg0, arg1, arg2) {
      defaultResult = AnimatedDivision.default(this, AnimatedDivision);
      items = [];
      items[0] = arg2;
      tmp2 = closure_1_9(this, AnimatedDivision, items);
      tmp2._warnedAboutDivideByZero = false;
      if (arg1 === 0) {
        tmp4 = globalThis;
        _console = console;
        ...
        tmp3 = closure_1_7;
        if (arg1 instanceof closure_1_7.default) {
        }
      }
      _default = arg0;
  ...
  closure_5.default(AnimatedDivision, arg0);
  let obj = {
    key: "__makeNative",
    value: function __makeNative(arg0) {
      ...
      const items = [arg0];
      closure_1_11(AnimatedDivision, "__makeNative", this, 3)(items);
    }
  };
  let items = [obj, , , , , ];
  obj = {
    ...
    value: function __getValue() {
      ...
      if (__getValueResult1 === 0) {
        ...
        return __getValueResult / __getValueResult1;
      }
  ...
  items[3] = {
    ...
    value: function __attach() {
      ...
      const _b = this._b;
      _b.__addChild(this);
      closure_1_11(AnimatedDivision, "__attach", this, 3)([]);
    }
  };
  items[4] = {
    key: "__detach",
    value: function __detach() {
      ...
      closure_1_11(AnimatedDivision, "__detach", this, 3)([]);
    }
  };
  items[5] = {
  ...
  return closure_1.default(AnimatedDivision, items);
