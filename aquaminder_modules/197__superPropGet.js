...
// Function ID: 2111
// Name: _superPropGet
// Dependencies: [1, 6, 26, 13, 12, 23, 25, 28, 198, 180, 186, 20, 189, 190]

// Module 197 (_superPropGet)
...
let items = ["abort", "error", "load", "loadstart", "progress", "timeout", "loadend"];
const combined = items.concat("readystatechange");
let closure_15 = ((_default2) => {
  class XMLHttpRequestEventTarget {
    constructor() {
      defaultResult = closure_1_5.default(this, XMLHttpRequestEventTarget);
      return closure_1_17(this, XMLHttpRequestEventTarget, arguments);
    }
  }
  closure_8.default(XMLHttpRequestEventTarget, _default2);
  return closure_4.default(XMLHttpRequestEventTarget);
})(pd.default.apply(undefined, items));
const tmp6 = ((_default3) => {
  class XMLHttpRequest {
    constructor() {
      defaultResult = closure_1_5.default(this, XMLHttpRequest);
      obj = closure_1_17(this, XMLHttpRequest);
      obj.UNSENT = closure_1_9;
      obj.OPENED = closure_1_10;
      obj.HEADERS_RECEIVED = closure_1_11;
      obj.LOADING = closure_1_12;
      obj.DONE = closure_1_13;
      obj.readyState = closure_1_9;
      obj.status = 0;
      obj.timeout = 0;
      obj.withCredentials = true;
      tmp2 = new closure_1_15();
      obj.upload = tmp2;
      obj._aborted = false;
      obj._hasError = false;
      obj._method = null;
      ...
      obj._startTime = null;
      obj._performanceLogger = XMLHttpRequest(closure_1_1[10]).default;
      _resetResult = obj._reset();
      return obj;
    }
  }
  closure_8.default(XMLHttpRequest, _default3);
  obj = {
    key: "_reset",
  ...
  obj = {
    ...
    set(_responseType) {
      if (this._sent) {
        ...
        throw error;
      } else if (closure_1_14.hasOwnProperty(_responseType)) {
        let tmp9 = closure_1_14[_responseType];
        if (!tmp9) {
          tmp9 = _responseType === "document";
        }
        const _HermesInternal2 = HermesInternal;
        XMLHttpRequest(closure_1_1[11])(tmp9, "The provided value '" + _responseType + "' is unsupported in this environment.");
        if (_responseType === "blob") {
          XMLHttpRequest(closure_1_1[11])(XMLHttpRequest(closure_1_1[9]).default.isAvailable, "Native module BlobModule is required for blob support");
          const tmp14 = XMLHttpRequest(closure_1_1[11]);
        }
  ...
  obj = {
    ...
    get() {
      ...
      return self.readyState < closure_1_12 ? "" : self._response;
    }
  };
  items[2] = obj;
  items[3] = {
    ...
    get() {
      ...
      if (responseType !== "") {
        if (responseType !== "text") {
          if (self.readyState !== closure_1_13) {
            return null;
            ...
            if ("document" === responseType) {
              ...
              self._cachedResponse = XMLHttpRequest(closure_1_1[12]).toByteArray(self._response).buffer;
              obj = XMLHttpRequest(closure_1_1[12]);
            } else if ("blob" === responseType) {
              if (typeof self._response === "object") {
                if (self._response) {
                  self._cachedResponse = XMLHttpRequest(closure_1_1[9]).default.createFromOptions(self._response);
                  const _default2 = XMLHttpRequest(closure_1_1[9]).default;
                }
              }
              if (self._response === "") {
                self._cachedResponse = XMLHttpRequest(closure_1_1[9]).default.createFromParts([]);
                const _default = XMLHttpRequest(closure_1_1[9]).default;
              } else {
                const _Error = Error;
      ...
      let str5 = "";
      if (self.readyState >= closure_1_12) {
        str5 = "";
        if (!self._hasError) {
          str5 = self._response;
        }
  ...
  items[5] = {
    ...
    value: function __didUploadProgress(arg0, loaded, total) {
      if (arg0 === this._requestId) {
        ...
        obj = { type: "progress", lengthComputable: true, loaded, total };
        upload.dispatchEvent(obj);
      }
    }
  };
  items[6] = {
  ...
  items[9] = {
    ...
    value: function __didReceiveDataProgress(arg0, loaded, total) {
      const self = this;
      if (arg0 === this._requestId) {
        obj = { type: "progress", lengthComputable: total >= 0, loaded, total };
  ...
  items[18] = {
    ...
    value: function send(arg0) {
      ...
      if (this.readyState !== this.OPENED) {
        ...
        _subscriptions.push(XMLHttpRequest(closure_1_1[13]).default.addListener("didSendNetworkData", (arg0) => {
        ...
        const _default = XMLHttpRequest(closure_1_1[13]).default;
        _subscriptions1.push(XMLHttpRequest(closure_1_1[13]).default.addListener("didReceiveNetworkResponse", (arg0) => {
        ...
        const _default2 = XMLHttpRequest(closure_1_1[13]).default;
        _subscriptions2.push(XMLHttpRequest(closure_1_1[13]).default.addListener("didReceiveNetworkData", (arg0) => {
        ...
        const _default3 = XMLHttpRequest(closure_1_1[13]).default;
        _subscriptions3.push(XMLHttpRequest(closure_1_1[13]).default.addListener("didReceiveNetworkIncrementalData", (arg0) => {
        ...
        const _default4 = XMLHttpRequest(closure_1_1[13]).default;
        _subscriptions4.push(XMLHttpRequest(closure_1_1[13]).default.addListener("didReceiveNetworkDataProgress", (arg0) => {
        ...
        const _default5 = XMLHttpRequest(closure_1_1[13]).default;
        _subscriptions5.push(XMLHttpRequest(closure_1_1[13]).default.addListener("didCompleteNetworkResponse", (arg0) => {
        ...
        XMLHttpRequest(closure_1_1[11])(self._method, "XMLHttpRequest method needs to be defined (%s).", _url);
        XMLHttpRequest(closure_1_1[11])(self._url, "XMLHttpRequest URL needs to be defined (%s).", _url);
        const _default7 = XMLHttpRequest(closure_1_1[13]).default;
  ...
  items[19] = {
    ...
    value: function abort() {
      ...
      this._aborted = true;
      if (this._requestId) {
        XMLHttpRequest(closure_1_1[13]).default.abortRequest(self._requestId);
        const _default = XMLHttpRequest(closure_1_1[13]).default;
      }
  ...
  items[21] = {
    ...
    value: function setReadyState(readyState) {
      ...
      if (readyState === this.DONE) {
        ...
        const dispatchEvent = self.dispatchEvent;
        const obj1 = {};
        if (self._timedOut) {
          obj1.type = "timeout";
          dispatchEvent(obj1);
  ...
  items[22] = {
    ...
    value: function addEventListener(arg0, arg1) {
      ...
      closure_1_16(XMLHttpRequest, "addEventListener", self, 3)(items);
    }
  };
  items[23] = {
    key: "_getMeasureURL",
  ...
  return closure_4.default(XMLHttpRequest, items, items1);
})(pd.default.apply(undefined, _toConsumableArray.default(combined)));
tmp6.UNSENT = 0;
tmp6.OPENED = 1;
tmp6.HEADERS_RECEIVED = 2;
tmp6.LOADING = 3;
tmp6.DONE = 4;
tmp6._interceptor = null;
tmp6._profiling = false;
