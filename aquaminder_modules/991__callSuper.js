...
export const PinchGesture = ((ContinousBaseGesture) => {
  class PinchGesture {
    constructor() {
      defaultResult = PinchGesture.default(this, PinchGesture);
      tmp2 = closure_1_6(this, PinchGesture);
      tmp2.handlerName = "PinchGestureHandler";
      return tmp2;
    }
  }
  closure_5.default(PinchGesture, ContinousBaseGesture);
  let items = [
    {
      key: "onChange",
      value: function onChange(arg0) {
        ...
        const items = [arg0];
        return closure_1_8(PinchGesture, "onChange", this, 3)(items);
      }
    }
  ];
  return closure_1.default(PinchGesture, items);
