...
export const RotationGesture = ((ContinousBaseGesture) => {
  class RotationGesture {
    constructor() {
      defaultResult = RotationGesture.default(this, RotationGesture);
      tmp2 = closure_1_6(this, RotationGesture);
      tmp2.handlerName = "RotationGestureHandler";
      return tmp2;
    }
  }
  closure_5.default(RotationGesture, ContinousBaseGesture);
  let items = [
    {
      key: "onChange",
      value: function onChange(arg0) {
        ...
        const items = [arg0];
        return closure_1_8(RotationGesture, "onChange", this, 3)(items);
      }
    }
  ];
  return closure_1.default(RotationGesture, items);
