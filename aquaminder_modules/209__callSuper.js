...
// Function ID: 2342
// Name: _callSuper
// Dependencies: [1, 203, 12, 13, 23, 25, 28, 183, 180, 191, 194, 33, 207, 210, 189, 198, 20]

// Module 209 (_callSuper)
...
import WebSocketEvent from "WebSocketEvent" /* 210 */;
...
let closure_6 = module_1(Blob);
let closure_7 = module_1(uuidv4);
let closure_8 = module_1(NativeEventEmitter);
let closure_9 = module_1(binaryToBase64);
let closure_10 = module_1(get_Version);
let closure_11 = module_1(WebSocketModule);
let closure_12 = module_1(WebSocketEvent);
let closure_13 = module_1(getLens);
const pd = module_1(pd2);
let closure_14 = module_1(invariant);
let closure_15 = ["headers"];
let c16 = 0;
const tmp4 = ((_default) => {
  class WebSocket {
    constructor(arg0, arg1, arg2) {
      obj = arg2;
      defaultResult = closure_1_1.default(this, WebSocket);
      obj2 = closure_1_17(this, WebSocket);
      obj2.CONNECTING = 0;
      obj2.OPEN = 1;
      obj2.CLOSING = 2;
      obj2.CLOSED = 3;
      ...
      defaultResult1 = WebSocket.default(obj, closure_1_15);
      if (defaultResult1) {
      ...
      _default = null;
      if (closure_1_10.default.OS === "ios") {
        tmp10 = closure_1_11;
        _default = closure_1_11.default;
      }
      _default1 = new closure_1_8.default(_default);
      ...
      obj = {};
      obj.headers = headers;
      connectResult = _default.connect(_default, tmp8, obj, obj2._socketId);
      return obj2;
    }
  }
  closure_5.default(WebSocket, _default);
  let obj = {
    key: "binaryType",
    get() {
    ...
    set(_binaryType) {
      ...
      if (self._binaryType === "blob") {
        closure_1_14.default(closure_1_7.default.isAvailable, "Native module BlobModule is required for blob support");
        if (_binaryType === "blob") {
          closure_1_7.default.addWebSocketHandler(self._socketId);
          const _default2 = closure_1_7.default;
        } else {
          const result = closure_1_7.default.removeWebSocketHandler(self._socketId);
  ...
  obj = {
    ...
    value: function send(str) {
      ...
      if (this.readyState === this.CONNECTING) {
        ...
        throw error;
      } else if (str instanceof closure_1_6.default) {
        closure_1_14.default(closure_1_7.default.isAvailable, "Native module BlobModule is required for blob support");
        closure_1_7.default.sendOverSocket(str, self._socketId);
      } else if (typeof str === "string") {
        closure_1_11.default.send(str, self._socketId);
      } else {
        ...
        closure_1_11.default.sendBinary(closure_1_9.default(str), self._socketId);
      }
    }
  };
  items[2] = obj;
  items[3] = {
    ...
    value: function ping() {
      if (this.readyState === this.CONNECTING) {
        ...
        closure_1_11.default.ping(tmp._socketId);
      }
    }
  };
  items[4] = {
    ...
    value: function _close(num, str) {
      ...
      num = 1000;
      str = "";
      closure_1_11.default.close(num, str, self._socketId);
      if (closure_1_7.default.isAvailable) {
        if (self._binaryType === "blob") {
          const result = closure_1_7.default.removeWebSocketHandler(self._socketId);
          const _default2 = closure_1_7.default;
        }
    ...
    value: function _registerEvents() {
      ...
      const items = [
        _eventEmitter.addListener("websocketMessage", (id) => {
          if (id.id === self._socketId) {
            ({ data, type } = id);
            if ("binary" === type) {
              data = closure_2_13.default.toByteArray(id.data).buffer;
              const _default2 = closure_2_13.default;
            } else if ("blob" === type) {
              data = closure_2_7.default.createFromOptions(id.data);
              const _default = closure_2_7.default;
            }
            let _default3 = closure_2_12.default;
            const obj = { data };
      ...
      items[1] = _eventEmitter2.addListener("websocketOpen", (id) => {
        if (id.id === self._socketId) {
          ...
          let _default = closure_2_12.default;
      ...
      items[3] = _eventEmitter4.addListener("websocketFailed", (id) => {
        if (id.id === self._socketId) {
          self.readyState = self.CLOSED;
          let _default = closure_2_12.default;
          let obj = { message: id.message };
          const prototype = _default.prototype;
          _default = new _default("error", obj);
          self.dispatchEvent(_default);
          let _default2 = closure_2_12.default;
  ...
  return closure_2.default(WebSocket, items);
})(pd.default.apply(undefined, ["close", "error", "message", "open"]));
tmp4.CONNECTING = 0;
tmp4.OPEN = 1;
tmp4.CLOSING = 2;
tmp4.CLOSED = 3;
