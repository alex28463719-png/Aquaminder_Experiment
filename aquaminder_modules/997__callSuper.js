...
export const ManualGesture = ((ContinousBaseGesture) => {
  class ManualGesture {
    constructor() {
      defaultResult = ManualGesture.default(this, ManualGesture);
      tmp2 = closure_1_6(this, ManualGesture);
      tmp2.handlerName = "ManualGestureHandler";
      return tmp2;
    }
  }
  closure_5.default(ManualGesture, ContinousBaseGesture);
  let items = [
    {
      key: "onChange",
      value: function onChange(arg0) {
        ...
        const items = [arg0];
        return closure_1_8(ManualGesture, "onChange", this, 3)(items);
      }
    }
  ];
  return closure_1.default(ManualGesture, items);
